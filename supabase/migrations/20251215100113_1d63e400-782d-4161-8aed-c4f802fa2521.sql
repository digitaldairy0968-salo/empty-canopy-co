-- Drop the existing restrictive update policy for dairy owners
DROP POLICY IF EXISTS "Dairy owners can use activation codes" ON public.activation_codes;

-- Create a new policy that allows dairy owners to update is_used, used_at, and dairy_id fields
